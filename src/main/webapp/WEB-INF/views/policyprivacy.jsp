...
<div class="dc-area">
    <div class="dc-wrapper">
        <div class="ppContents">
            <br />
            <h3><b>개인정보처리방침</b></h3><br />
            <br />
            런치 컨테이너(이하 ‘당사’라함)이 소유하고 운영하는 런치 컨테이너 어플리케이션과 이와 관련된 웹사이트들(이하 ‘런치 컨테이너’라 함)은 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.<br />
            <br />
            당사는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.<br />
            <br />
            <br />
            1. 개인정보의 처리 목적: 당사는 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.<br />
            가. 홈페이지 회원가입 및 관리<br />
            ...
            마. 개인영상정보<br />
            범죄의 예방 및 수사, 교통단속, 교통정보의 수집·분석 및 제공 등을 목적으로 개인정보를 처리합니다.<br />
            <br />
            2. 개인정보 파일 현황<br />
            당사가 개인정보 보호법 제32조에 따라 등록/공개하는 개인정보파일의 처리목적은 다음과 같습니다.<br />
            가. 개인정보 파일명 : 개인정보파일<br />
            - 개인정보 수집항목<br />
            회원가입시(필수) : 이메일, 비밀번호, 이름, 태어난해, 성별<br />
            회원가입시(선택) : 전화번호<br />
            - 수집방법 : 서면양식, 홈페이지<br />
            ...
            1) 쿠키의 사용 목적 : 런치 컨테이너의 각 서비스와 방문형태 및 좋아요한맛집 등을 파악하여 이용자에게 최적화된 정보 제공을 위하여 사용합니다.<br />
            2) 쿠키의 설치/운영 및 거부<br />
            - 이용자는 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서 이용자는 웹브라우저에서 옵션을 설정함으로써 모든 쿠키를 허용하거나, 쿠키가 저장될 때마다 확인을 거치거나, 아니면 모든 쿠키의 저장을 거부할 수도 있습니다.<br />
            - 다만, 쿠키의 저장을 거부할 경우에는 로그인이 필요한 런치 컨테이너의 일부 서비스 이용에 어려움이 있을 수 있습니다. <br />
            ...
            당사는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집시에 동의 받은 개인정보 보유,이용기간 내에서 개인정보를 처리,보유합니다. 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.<br />
            ...
            5) 표시/광고에 관한 기록 : 6개월 (전자상거래등에서의 소비자보호에 관한 법률)<br />
            <br />
            4. 개인정보의 제3자 제공에 관한 사항<br />
            가. 당사는 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.<br />
            나. 당사는 현재 개인정보를 제3자에게 제공하지 않고 있습니다.<br />
            <br />
            5. 개인정보처리 위탁<br />
            가. 원활한 개인정보 업무처리를 위하여 개인정보 처리업무를 위탁할수 있습니다. 현재는 위탁하고 있는 업무처리가 없으며 위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을 통하여 공개하도록 하겠습니다.<br />
            <br />
            ...
            ④  런치 컨테이너는 법정 대리인의 동의가 필요한 만14세 미만 아동의 회원가입은 받고 있지 않습니다. 이에 따라 별도의 법정대리인의 권리와 취급 방침은 두고 있지 않습니다.<br />
            ⑤ 제1항에 따른 권리 행사는 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보 보호법 시행규칙 별지 제11호 서식에 따른 위임장을 제출하셔야 합니다.<br />
            <br />
            7. 처리하는 개인정보의 항목 작성<br />
            당사는 다음의 개인정보 항목을 처리하고 있습니다.<br />
            - 홈페이지 회원가입 및 관리에 필수적인 항목 : 개인정보의 처리 목적, 개인정보파일 현황, 개인정보의 처리 및 보유 기간, 정보주체의 권리·의무 및 그 행사방법에 관한 사항, 처리하는 개인정보의 항목, 개인정보의 파기에 관한 사항, 개인정보 보호책임자에 관한 사항, 개인정보 처리방침의 변경에 관한 사항, 개인정보의 안전성 확보조치에 관한 사항<br />
            - 선택항목 : 정보주체의 권익침해에 대한 구제방법<br />
            <br />
            8. 개인정보의 파기<br />
            당사는 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.<br />
            - 파기절차<br />
            이 용자가 입력한 정보는 목적 달성 후 별도의 DB에 옮겨져(종이의 경우 별도의 서류) 내부 방침 및 기타 관련 법령에 따라 일정기간 저장된 후 혹은 즉시 파기됩니다. 이 때, DB로 옮겨진 개인정보는 법률에 의한 경우가 아니고서는 다른 목적으로 이용되지 않습니다.<br />
            - 파기기한<br />
            ...
            당사는 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.<br />
            ...
            <br />
            10. 개인정보 보호책임자 작성<br />
            ① 당사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br />
            - 고객서비스 담당 부서 : CS팀<br />
            - 전화번호 : 02-1234-5678<br />
            - 이메일 : abc@abc.com <br />
            - 개인정보관리책임자 성명 : 홍길동<br />
            ② 정보주체께서는 당사의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 당사는 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.<br />
            <br />
            11. 개인정보 처리방침 변경<br />
            이 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.<br />
            <br />
            <br />
            - 최근 개정일: 2017년 7월 3일(시행일 2017일 7월 3일)<br />
        </div>
    </div>
</div>
</body>
